...
export function CatSection() {
  return (
    <SectionWrapper id="cat" className="bg-slate-50 border-b border-slate-200/80 transition-colors duration-300">
      {/* Header */}
      <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
          The <span className="text-primary-600">CAT Framework</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
        {catFramework.map((item, idx) => {
          ...
          return (
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-blue-50 text-primary-600 flex items-center justify-center mb-6 shrink-0 shadow-xs">
              ...
              <p className="text-sm font-semibold text-amber-600 mb-3">{item.title}</p>
