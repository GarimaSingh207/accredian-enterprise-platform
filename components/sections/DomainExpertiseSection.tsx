...
export function DomainExpertiseSection() {
  return (
    <SectionWrapper id="domain-expertise" className="bg-white border-b border-neutral-100">
      {/* Header */}
      <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-neutral-900">
          Tailored <span className="text-accent-500">Domain Expertise</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {domainHubs.map((hub) => {
          ...
          return (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-primary-50 text-primary-600 group-hover:bg-primary-600 group-hover:text-white transition-colors flex items-center justify-center shrink-0">
