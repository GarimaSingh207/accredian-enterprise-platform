...
export function FaqSection() {
  ...
  return (
    <SectionWrapper id="faqs" className="bg-section-alt border-b border-neutral-100">
      {/* Header */}
      ...
      {/* Bottom CTA */}
      <div className="text-center bg-white border border-primary-100 p-8 rounded-2xl max-w-xl mx-auto shadow-xs">
