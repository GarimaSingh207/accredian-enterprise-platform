      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 pb-8 border-b border-neutral-800">
          <div className="space-y-3">
            ...
            {/* Circular Social Icons with Glow and Rotate Hover */}
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-full bg-neutral-800/80 hover:bg-primary-600 hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-1.1 hover:rotate-10 hover:shadow-[0_0_15px_rgba(37,99,235,0.5)] text-neutral-400"
              >
