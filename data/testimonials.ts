...
export const testimonials: Testimonial[] = [
  {
    id: 'test-adp',
    companyName: 'ADP',
    logoSrc: '/images/clients/adp.svg',
    logoAlt: 'ADP Logo',
    ...
    authorName: 'Senior L&D Lead',
    authorTitle: 'ADP Enterprise',
  },
  {
    id: 'test-bayer',
    companyName: 'Bayer',
    logoSrc: '/images/clients/bayer.svg',
    logoAlt: 'Bayer Logo',
    ...
    authorName: 'Head of Talent Development',
    authorTitle: 'Bayer Global',
  },
];
